                ...
                errors.map(e => (
                    <div className={`row font-size-sm mt-1`}  key={e.code}>
                        <span
                            ...
                            data-place="bottom"
                            data-effect="float"
                            data-tip={`<span class="column jc-between col-100">${t('ImageInput.iconErrorText')}</span>`}>
                            <Icon iconName=" icon-help-circled-1 text-red font-size-md" customClass={`cursor-pointer`}/>
                        </span>
                ...
                <input {...getInputProps()}/>
                {
                    !files[0]?.preview ?
                        <div className={`column`}>
                            <span>{props.title} {!fileRejectionItems.length > 0  ?  t('ImageInput.dropText') : "" }</span>
