        ...
        <Fragment>
            <div className={`column ai-center jc-between mainMenu-background ${classes.container}`}>
                ...
                <div className={`column jc-end ai-center`}>
                    <span className={`text-color ${classes.messages} ${showMessages ? classes.selected :""}`}
            ...
            <Fragment>
                <div className={`${classes.subMenu} ${showMessages ? classes.show :""}`}>
                    <MessagesSubMenu/>
                </div>
                <div className={`${classes.subMenuWrapper} ${showMessages ? classes.show :""}`} onClick={()=>setShowMessages(false)}/>
            </Fragment>
