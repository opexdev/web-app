...
import classes from './WithdrawTx.module.css';
import {Link, useParams} from "react-router-dom";
import {Trans, useTranslation} from "react-i18next";
import {useGetDepositHistory, useGetWithdrawHistory} from "../../../../../../../../../../queries";
import Loading from "../../../../../../../../../../components/Loading/Loading";
import Error from "../../../../../../../../../../components/Error/Error";
import DepositTxTable from "../DepositTxTable/DepositTxTable";
import WithdrawTxTable from "../WithdrawTxTable/WithdrawTxTable";
    ...
    return (
        <div className={`width-49 card-bg card-border column ${classes.container}`}>
            <div className="flex jc-between card-header-bg py-2 px-1">
                ...
                <Link to={Routes.Withdraw} className={`row jc-center ai-center cursor-pointer hover-text fs-0-7`}>
