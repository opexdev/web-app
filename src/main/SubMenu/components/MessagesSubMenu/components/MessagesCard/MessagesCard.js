...
const MessagesCard = (props) => {
    ...
    return (
        <div style={{height: "100%"}}>
            <ScrollBar>
                {/*{items}*/}
                <div className={`container column jc-center px-05  ${classes.container} `}>
                    <div className={`container row font-size-sm-plus`}>
                        ...
                        <div className="col-90 container row jc-between ai-center">
                            ...
                            <Icon iconName="icon-menu_vertical font-size-sm-plus flex" customClass={`cursor-pointer ${classes.iconBG}`}/>
                        </div>
                    </div>
