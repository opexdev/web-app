...
const DevelopLogin = (props) => {
  ...
  const login = (
    <form
      onSubmit={(e) => submit(e)}
      className={`column jc-between ${classes.form} `}>
      <div>
        <TextInput
          lead="نام کاربری"
          type="text"
  ...
  return (
    <div
      ...
      style={{backgroundImage: `url("${images.ho}")`}}>
      <div className={`row ${classes.row}`}>
        <div
          className="column col-50 jc-center ai-center px-1"
        ...
        <div
          className={`container  col-50 ai-center jc-center px-1 ${classes.space} ${classes.moveImage}`}
          style={{backgroundImage: `url("${images.spaceBackgroundStars}")`}}>
          <div
            className={`container column ai-center jc-center ${classes.intro} ${classes.moveImage}`}
            style={{backgroundImage: `url("${images.starBtc}")`}}>
