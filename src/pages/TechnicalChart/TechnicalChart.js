...
const TechnicalChart = (props) => {
    ...
    return (
        <div  className={`row  ${props.isDark ? 'dark' : ''} ${ltr ? "ltr" : "rtl"} ${isSafari ? "" : "user-select"}`}>
            <ReactTooltip data-html={true} data-effect="float"/>
            <MainMenu/>
            <div  className="column content" style={{width:"100%",marginRight: "5%",backgroundColor:"var(--cardBody)"}}>
