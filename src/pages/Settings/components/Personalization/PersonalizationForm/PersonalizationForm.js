    ...
    return (
        <div className="container py-2">
            <div className={` card-background card-border column ${classes.container}`}>
                ...
                <div className={`container column jc-between ai-center px-1 py-2 ${classes.content}`}>
                        <div className="row jc-between">
                            <div className="col-49">
                                <TextInput
                                    ...
                                    onchange={(e)=> setPersonalization({...personalization,defaultLanguage: e.value})}
                                />
                            </div>
                            <div className="col-49">
                                <TextInput
                                    ...
                                    onchange={(e)=> setPersonalization({...personalization,defaultTheme: e.value})}
                                />
                            </div>
                        </div>
                        <div className="row jc-between">
                            <div className="col-49">
                                <TextInput
                                    ...
                                    onchange={(e)=> setPersonalization({...personalization,calendarSystem: e.value})}
                                />
                            </div>
                            <div className="col-49">
                                <TextInput
                                    ...
                                    onchange={(e)=> setPersonalization({...personalization,timeZone: e.value})}
                                />
                            </div>
                        </div>
                        <div className="row jc-between">
                            <div className="col-49">
                                <TextInput
                                    ...
                                    onchange={(e)=> setPersonalization({...personalization,referenceCurrency: e.value})}
                                />
                            </div>
                            <div className="col-49">
                                <TextInput
                                    ...
                                    onchange={(e)=> setPersonalization({...personalization,referenceCryptoCurrency: e.value})}
                                />
                            </div>
                        </div>
                        <div className="row jc-end pt-1">
                            <button type="submit" className={`cursor-pointer ${classes.button}`}>ذخیره</button>
                        </div>
                </div>
            </div>
        </div>
