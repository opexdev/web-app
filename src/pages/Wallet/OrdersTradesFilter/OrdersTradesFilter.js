                ...
                customData.aliveOrder.map((tr, index) =>
                    <Fragment key={index}>
                        <tr className={tr.side === "buy" ? "text-green" : "text-red"}>
                            ...
                            <td>{tr.order}</td>
                            <td>{(tr.market === "BTC/IRT") || (tr.market === "BTC/USDT") ? "BTC" : "ETH" }</td>
                            <td>{tr.done}</td>
                        ...
                        <tr style={{display: openItem.aliveOrder === index ? "revert" : "none"}}>
                ...
                customData.ordersHistory.map((tr, index) =>
                    <Fragment key={index}>
                        <tr className={tr.side === "buy" ? "text-green" : "text-red"}>
                            ...
                            <td>{t("pair." + tr.market)}</td>
                            <td>{(tr.side === "buy") ? t('buy') : t('sell') }</td>
                            <td>{(tr.type === "market") ? t('OrdersTrades.market') : t('OrdersTrades.limit') }</td>
                            <td>{tr.order}</td>
                            <td>{(tr.market === "BTC/IRT") || (tr.market === "BTC/USDT") ? "BTC" : "ETH" }</td>
                            <td>{tr.done}</td>
                            <td>{tr.pricePerUnit.toLocaleString()}</td>
                        ...
                        <tr style={{display: openItem.ordersHistory === index ? "revert" : "none"}}>
                            <td colSpan="13" className={`py-1 px-2`}>
                                <div className="row jc-around  ai-center" style={{width: "100%"}}>
            ...
            <tbody>
            {
                customData.trades.map((tr, index) =>
                    <Fragment key={index}>
                        ...
                        <tr style={{display: openItem.trades === index ? "revert" : "none"}}>
                            <td colSpan="13" className={`py-1 px-2`}>
                                <div className="row jc-around  ai-center" style={{width: "100%"}}>
